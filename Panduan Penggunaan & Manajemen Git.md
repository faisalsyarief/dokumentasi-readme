...
Sebelum melakukan rilis, buat tag versi dengan perintah:
```
git tag -a v2.0.0 -m "release feature 2.0.0"
```
...
Untuk mengambil perubahan dari dua commit tertentu dan menggabungkannya dalam satu branch aktif, gunakan perintah:
```
git cherry-pick idcommit1 idcommit2
```
